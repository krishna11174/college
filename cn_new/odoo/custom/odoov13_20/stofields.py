...
class StoFieldsPicking(models.Model):
	...
	pick_out = fields.Char(string='DC Reference', compute = 'get_out_name')
	pick_in = fields.Char(string='GRN Reference', compute='get_in_name')
	eff_grn_dt = fields.Date(string='Effective GRN Date', compute='get_grn_dt')
	eff_del_dt = fields.Date(string='Effective Delivery Date', compute='get_del_dt')
	# @api.depends('name')
