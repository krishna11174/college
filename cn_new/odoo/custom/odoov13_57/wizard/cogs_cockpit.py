...
class CogsReport(models.TransientModel):
    ...
    def generate_report(self):
        ...
        tree_view_id = self.env.ref('odoov13_57.view_cogs_cockpit_tree').id
        form_view_id = self.env.ref('odoov13_57.cogscockpit_view_form').id
        pivot_view_id = self.env.ref('odoov13_57.view_pivot_cogs_cockpit').id
        graph_view_id = self.env.ref('odoov13_57.cogs_cockpit_graph').id
